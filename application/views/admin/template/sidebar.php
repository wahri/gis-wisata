<aside class="navbar navbar-vertical navbar-expand-lg navbar-light">
    <div class="container">
        ...
        <a href="." class="navbar-brand navbar-brand-autodark">
            <img src="<?= base_url('assets/') ?>img/wonderful.png" alt="Tabler" class="navbar-brand-image">
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbar-menu">
            <ul class="navbar-nav pt-lg-3">
                <li class="nav-item <?= $nav_active == 'dashboard' ? 'active' : '' ?>">
                ...
                <!-- <li class="nav-item <?= $nav_active == 'map' ? 'active' : '' ?>">
                    <a class="nav-link" href="<?= base_url('admin/map/tambahdata') ?>">
                        <span class="nav-link-icon d-md-none d-lg-inline-block"><svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z" />
                ...
                <li class="nav-item dropdown  <?= $nav_active == 'map' ? 'active' : '' ?>">
                    ...
                    <ul class="dropdown-menu dropdown-menu-columns  dropdown-menu-columns-3">
                        <li>
                            <a class="dropdown-item" href="<?= base_url('admin/map') ?>">
                                List Data
                            </a>
                        </li>
                        <li>
                            <a class="dropdown-item" href="<?= base_url('admin/map/tambahdata') ?>">
                                Tambah Data
                            </a>
                        </li>
                    </ul>
